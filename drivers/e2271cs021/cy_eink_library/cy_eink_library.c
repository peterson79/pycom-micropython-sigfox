...
void Cy_EINK_DelayMs(uint32_t delayMs){
...
static int currentScreenContent = STARTUP_CONTENT;
static cy_eink_image_t* currentFrame;
#define NUMBER_OF_STARTUP_SCREENS (1)
 ...
 *
 *******************************************************************************/
void DisplayImage(cy_eink_image_t* imagePointer)
{
...
cy_eink_api_result Cy_EINK_Start(int8_t temperature,
                                 cy_eink_delay_function_t delayFunction, int speed)
{
