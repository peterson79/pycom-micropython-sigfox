...
extern int CY_EINK_Ssel_PORT;
extern int CY_EINK_Ssel_NUM;

extern int CY_EINK_DispRst_PORT;
extern int CY_EINK_DispRst_NUM;

extern int CY_EINK_Discharge_PORT;
extern int CY_EINK_Discharge_NUM;

extern int CY_EINK_DispBusy_PORT;
extern int CY_EINK_DispBusy_NUM;

extern int CY_EINK_DispIoEn_PORT;
extern int CY_EINK_DispIoEn_NUM;

extern int CY_EINK_Border_PORT;
extern int CY_EINK_Border_NUM;

extern int CY_EINK_DispEn_PORT;
extern int CY_EINK_DispEn_NUM;

extern int CY_EINK_SCLK_NUM;
extern int CY_EINK_MOSI_NUM;
extern int CY_EINK_MISO_NUM;
